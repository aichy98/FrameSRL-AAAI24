...
def parse_args():
    ...
    parser.add_argument(
        "--num_warmup_steps", type=float, default=0.05, help="Ratio of steps for the warmup in the lr scheduler."
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=512,
        help="The rank for CPD.",
    )
    parser.add_argument(
        "--num_iterations",
        type=int,
        default=3,
        help="num_iterations of MFVI.",
    )
    parser.add_argument(
        "--max_grad_norm",
        type=float,
        default=None,
        help="max_grad_norm. If not provided, gradient clipping is not performed.",
    )
    parser.add_argument(
        "--log_every_step",
        type=int,
